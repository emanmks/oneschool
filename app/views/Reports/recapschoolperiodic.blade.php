...
<section class="content-header">
    <h1>Rekap Sekolah Periodik</h1>
    <ol class="breadcrumb">
        <li><a href="{{ URL::to('/') }}"><i class="fa fa-desktop"></i> Home</a></li>
        <li><a href="{{ URL::to('laporan') }}"> Laporan</a></li>
        <li><a href="{{ URL::to('laporan/rekap-sekolah-periodik') }}"><i class="active"></i> Rekap Sekolah Periodik</a></li>
    </ol>
</section>
            ...
            <div class="box">
                <div class="box-body table-responsive">
                    <table class="table table-striped table-condensed">
                        <thead>
                            <tr class="success">
                                <th colspan="{{ count($periods) + 3 }}"><center>Rekap Sekolah Periodik</center></th>
                            </tr>
                            <tr class="warning">
                                <th>Sekolah</th>
