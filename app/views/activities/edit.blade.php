                ...
                <div class="box-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                <script type="text/javascript">
                                	$('select[name=location]').val("{{ $activity->location_id }}");
                                </script>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <input name="agenda" type="text" class="form-control" data-provider="datepicker" value="{{ date('Y-m-d', strtotime($activity->agenda)) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                ...
                                <script type="text/javascript">
                                	$('select[name=coordination]').val("{{ $activity->coordination }}");
                                </script>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function update()
    {
        var id = $('input[name=activity_id]').val();
