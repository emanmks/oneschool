...
<section class="content-header">
    <h1>Input Nilai Quiz Kelas <small>{{ $course->name }}</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ URL::to('/') }}"><i class="fa fa-desktop"></i> Home</a></li>
        <li><a href="#"> Akademik</a></li>
        <li><a href="{{ URL::to('kuis') }}/{{ $course->id }}"><i class="active"></i> Nilai Quiz</a></li>
    </ol>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header"><h2 class="box-title">Form Nilai Quiz</h2></div>
                ...
                <div class="box-body">
                    ...
                    <form class="form form-horizontal">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-lg-2">
	                           	<input type="text" class="form-control" name="quiz_date" value="{{ date('Y-m-d') }}">
	                        </div>
	                    </div>
                    </form>
                    ...
                    <table class="table table-striped table-condensed">
                        ...
                        @foreach($course->placements as $placement)
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="point-{{ $placement->issue_id }}" class="form-control" value="0.00">
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
                    <button class="btn btn-primary" onclick="createPoints()"><i class="fa fa-floppy-o"></i> Setor Nilai Quiz</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function createPoints()
    {
        ...
        if(course_id != '0' && issues.length > 0 && points.length > 0 && subject_id != '0' && employee_id != '0')
        {
        	$.ajax({
        		url:"{{ URL::to('quiz') }}",
        		type:"POST",
