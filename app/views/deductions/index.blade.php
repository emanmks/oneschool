           ...
           @if(Session::has('message'))
            ...
            <div class="box">
                <div class="box-body table-responsive">
                    ...
                    <a href="{{ URL::to('deduction') }}/create" class="btn btn-success"><i class="fa fa-plus"></i> Tambahkan Deduction</a>
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="data-table">
                        ...
                        @foreach($deductions as $deduction)
                            <tr>
                                ...
                                <td><span class="badge bg-blue">Rp{{ number_format($deduction->nominal,2,',',',') }}</span></td>
                                <td>
                                    <div class="mytooltip">
                                        <a href="{{ URL::to('deduction') }}/{{ $deduction->id }}/edit" data-toggle="tooltip" data-placement="top" title="Klik untuk Koreksi"><i class="fa fa-edit"></i></a>
                                        &nbsp;
                                        <a href="#" onclick="destroy({{ $deduction->id }})" data-toggle="tooltip" data-placement="top" title="Batalkan!!!"><i class="text-danger fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
...
<script type="text/javascript">
    ...
    function filter()
    {
        ...
        window.location = "{{ URL::to('deduction/filter') }}/"+curr_month+"/"+curr_year;
    }
    ...
    function destroy(id)
    {
        if(confirm("Yakin akan membatalkan income salary?!"))
        {
            $.ajax({
                ...
                type:"DELETE",
                success:function(){
                    window.location = "{{ URL::to('deduction') }}";
                }
            });
        }
    }
