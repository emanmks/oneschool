...
<section class="content-header">
    <h1>
        Bukti Penerbitan Deduction Salary
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ URL::to('/') }}"><i class="fa fa-desktop"></i> Home</a></li>
        <li><a href="#"> Kepegawaian</a></li>
        <li><a href="{{ URL::to('deduction') }}"><i class="active"></i> Deduction Salary</a></li>
    </ol>
</section>
         ...
         <div class="col-xs-12">
            <small>
                <table class="table table-condensed">
                    <thead>
                        <tr class="success">
                            <th><i class="fa fa-files-o"></i>  Bukti Penerbitan Deduction Salary</th>
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="warning">
                            ...
                            <th width="50%">Jenis Deduction</th>
                    ...
                    <tbody>
                        <tr>
                        	...
                        	<td><span class="pull-right">Rp{{ number_format($deduction->nominal,2,",",".") }}</span></td>
               	...
               	Catatan : <i>{{ $deduction->comments }}</i>
            </small>
        </div>
    </div>
