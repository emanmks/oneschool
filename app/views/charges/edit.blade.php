                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input name="name" type="text" class="form-control" value="{{ $charge->name }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="nominal">Nominal</label>
                            <div class="col-lg-3">
                                <input name="nominal" type="text" class="form-control currency" value="{{ number_format($charge->nominal,2,',','.') }}">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function update()
    {
        var id = $('input[name=charge_id]').val();
